package com.ksknt.test.mob.and.appcontainer.dessertClicker
...
object DessertClickerAppDestination: NavigationDestination {
    override val route = "dessertClicker"
    override val title = R.string.dessert_clicker_screen
}
...
fun AffirmationsApp(
    ...
    Scaffold(
        ...
        topBar = {
            CustomAppBar(
                currentScreen = DessertClickerAppDestination,
                showBackButton = true,
...
fun DessertClickerApp(
    navController: NavHostController,
    desserts: List<Dessert> = DessertDatasource().loadDesserts()
) {
